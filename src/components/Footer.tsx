  ...
  return (
    <footer className="bg-black text-white">
      <div className="container-wide py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="mb-6 opacity-80">
              Our expertise in IT, Import/Export, and Construction combines precision, insight, and vision to elevate your business.
            </p>
          ...
          <div>
            ...
            <address className="not-italic">
              <p className="mb-3 opacity-80">R-18 sector 10 </p>
              <p className="mb-3 opacity-80">North karachi</p>
              <p className="mb-3 opacity-80">Pakistan</p>
              <p className="mb-3">
                <a href="tel:+11234567890" className="text-white transition-all duration-200 group hover:text-transparent hover:bg-gradient-to-r hover:from-[#ae8625] hover:via-[#ae8625] hover:to-[#edc967] hover:bg-clip-text">021-36930725</a>
              </p>
              <p>
                <a href="mailto:abc@gmail.com" className="text-white transition-all duration-200 group hover:text-transparent hover:bg-gradient-to-r hover:from-[#ae8625] hover:via-[#ae8625] hover:to-[#edc967] hover:bg-clip-text">info@prismgoldenenterprises.com</a>
              </p>
            </address>
        ...
        <div className="border-t border-bg-gradient-to-r from-[#ae8625] via-[#ae8625] to-[#edc967] bg-clip-text  mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
