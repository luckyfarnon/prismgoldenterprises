...
const CustomServicesSection = () => {
  ...
  return (
    <section id="custom-services-section" className="section-padding bg-black overflow-hidden">
      <div className="container-wide">
        <div className="text-center max-w-3xl mx-auto mb-16" data-aos="fade-up">
          <h2 className="heading-xl mb-4 bg-gradient-to-r from-[#ae8625] via-[#ae8625] to-[#edc967] bg-clip-text text-transparent">Our Specialized Services</h2>
          <h3 className="heading-lg mb-6 text-white">Expert Solutions for Your Industry</h3>
